      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <Card className="border-border/50 bg-card/50 backdrop-blur-xl shadow-2xl">
          <CardHeader className="text-center space-y-4">
            ...
            <CardTitle className="font-display text-2xl uppercase tracking-wide">Follow Your Team</CardTitle>
            <CardDescription>
              Enter your team code to follow the team as a supporter
            </CardDescription>
          </CardHeader>
              ...
              <>
                ...
                <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                  <p className="text-xs text-blue-200">
                    💡 With a team code, you'll get access to match schedules, team updates, and live stats.
                  </p>
                </div>
              </>
            ) : (
              <div className="space-y-6 text-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Start following the team. Redirecting to your dashboard...
                  </p>
                </div>
              </div>
            )}
