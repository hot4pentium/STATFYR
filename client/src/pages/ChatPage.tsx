  ...
  return (
    <Layout>
      <div className="h-[calc(100vh-140px)] flex gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        {/* Contacts List */}
        <Card className="w-80 bg-card border-white/5 flex flex-col">
          <CardHeader className="p-4 border-b border-white/5">
             <CardTitle className="font-display uppercase tracking-wide text-lg">Team Chat</CardTitle>
             <Input placeholder="Search teammates..." className="bg-background/50 border-white/10 mt-2" />
          </CardHeader>
          <ScrollArea className="flex-1">
             <div className="p-2 space-y-1">
                <div className="px-3 py-2 text-xs font-bold uppercase text-muted-foreground">Channels</div>
        ...
        <Card className="flex-1 bg-card border-white/5 flex flex-col overflow-hidden">
           <div className="p-4 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
              <div className="flex items-center gap-3">
                 <span className="font-display text-xl font-bold uppercase"># General</span>
                 <span className="text-sm text-muted-foreground">| Team Announcements & Discussion</span>
              </div>
