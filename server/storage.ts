...
export interface IStorage {
  ...
  updateUser(id: string, data: Partial<InsertUser> & { lastAccessedAt?: Date }): Promise<User | undefined>;
...
export class DatabaseStorage implements IStorage {
  ...
  async updateUser(id: string, data: Partial<InsertUser> & { lastAccessedAt?: Date }): Promise<User | undefined> {
    const [user] = await db
      .update(users)
      .set(data)
