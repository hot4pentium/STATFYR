...
-   **Season Management**: Coaches can start and end seasons, which archives historical data such as team records, top performers, and supporter engagement metrics. A dedicated Season History page allows reviewing past season data.
